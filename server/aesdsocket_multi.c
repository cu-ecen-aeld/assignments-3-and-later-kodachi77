...
// (and both disk and network access is extremely slow) my guess was that if I used event loop (epoll in my case) I would get similar performance
...
#ifndef EPOLL_LOOP
#ifdef EPOLL_LOOP_MULTI_THREADED
#undef EPOLL_LOOP_MULTI_THREADED
#endif
